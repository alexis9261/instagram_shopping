...
<section class="section-decorated-bottom">
  <div class="container mt-5 mt-md-3">
    <div class="row justify-content-center align-items-center">
      <div class="col-6 d-none d-sm-block text-center" style="mix-blend-mode: multiply;">
        <img src="{{asset('contact.svg')}}" alt="tienda de instagram">
      </div>
      <div class="col-12 col-md-6 mt-5 mt-md-0"> 
        @if(session()->has('usuario_hot'))
          <h1 class="text-center" style="font-family: Rubik;"><b>{{session()->get('usuario_hot', '').','}}</b> Gracias por dejarnos tus datos, pronto recibiras los precios por Correo. <br> 
            <b>¡Esta atento!<b> 
          </h1>
        @else
        <h2 class="text-center" style="font-family: Rubik;">
          ¿ Buscas activar Instagram Shopping ?
        </h2>
        <p class="text-center h5">
          <b>@if (session()->has('usuario_hot')) {{session()->get('usuario_hot', '').','}} @endif</b>
          Contacta con nosotros y te ayudamos en el proceso de activación.
        </p>
        @endif
      </div>
    </div>
...
<section  class="bg-white section-decorated-bottom mt-3">
  ...
  <div class="container px-5">
    <div class="row justify-content-between align-items-center text-center text-md-left">
      ...
      <div class="col-md-4 text-lg-right">
        <a href="https://api.whatsapp.com/send?phone=584124038648&text=Hola,%20Quiero%20conversar%20de%20mi%20proyecto.%20" class="btn btn-primary btn-rounded px-5">
        <div class="row align-items-center">
          <i class="svg-icon fs-30 text-primary col-auto">
